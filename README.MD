...
I build this project following the tutorial online to learn how to build B2Bs application and Admin Dashboard, that uses Refine Dev tool to build enterprise level applications to help developers, dev ops, HR and others personals in the enterprise.
